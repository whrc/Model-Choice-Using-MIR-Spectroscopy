...
## 03.28.2018 Shree	  A bug when predicting only one sample was fixed, which was likely due to conversion of matrix into vector.
## 03.28.2018 Shree   The sbl output has been expanded to include samples used for predicting each element of validation set 
##                      Also, coefficient and intercept corresponding to the best plsr for predicting new samples has been added to the sbl output
